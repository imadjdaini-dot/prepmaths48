...
-- CreateEnum
CREATE TYPE "Level" AS ENUM ('TRONC_COMMUN', 'BAC_1', 'BAC_2', 'CONCOURS');

-- CreateEnum
CREATE TYPE "Track" AS ENUM ('SM', 'S_EX', 'MEDECINE', 'ENSA');

-- CreateEnum
CREATE TYPE "CourseKind" AS ENUM ('COURS', 'CONCOURS');

-- CreateEnum
CREATE TYPE "VideoProvider" AS ENUM ('LOCAL', 'BUNNY', 'CLOUDFLARE', 'VIMEO', 'YOUTUBE');

-- CreateEnum
CREATE TYPE "ResourceType" AS ENUM ('PDF', 'DOC', 'IMAGE', 'OTHER');

-- CreateEnum
CREATE TYPE "Difficulty" AS ENUM ('FACILE', 'MOYEN', 'DIFFICILE');

-- CreateEnum
CREATE TYPE "SubscriptionPlan" AS ENUM ('GRATUIT', 'COURS', 'CONCOURS');
...
CREATE TABLE "Course" (
    ...
    "level" "Level",
    "track" "Track",
    "kind" "CourseKind" NOT NULL DEFAULT 'COURS',
...
CREATE TABLE "Lesson" (
    ...
    "description" TEXT,
    "videoUrl" TEXT,
    "videoProvider" "VideoProvider" NOT NULL DEFAULT 'LOCAL',
...
CREATE TABLE "Resource" (
    ...
    "fileType" "ResourceType" NOT NULL DEFAULT 'PDF',
...
CREATE TABLE "Question" (
    ...
    "explanation" TEXT,
    "tip" TEXT,
    "difficulty" "Difficulty" NOT NULL DEFAULT 'MOYEN',
    "order" INTEGER NOT NULL DEFAULT 0,
